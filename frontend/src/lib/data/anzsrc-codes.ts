/**
 * ANZSRC 2020 Field of Research codes — auto-generated from ANZSRC2020_source.csv
 * DO NOT EDIT MANUALLY.
 */

export const ANZSRC_CODES: Record<string, string> = {
...
export const ANZSRC_DIVISIONS: Record<string, string> = {
...
export const ANZSRC_GROUPS: Record<string, string> = {
...
export function getCodeDescription(code: string): string {
  return ANZSRC_CODES[code] ?? `Code ${code}`;
}

export function getCodeDivision(code: string): string {
  const divKey = code.slice(0, 2);
  return ANZSRC_DIVISIONS[divKey] ?? "Unknown Division";
}

export function getCodeGroup(code: string): string {
  const grpKey = code.slice(0, 4);
  return ANZSRC_GROUPS[grpKey] ?? "Unknown Group";
}
